...
CMD="curl -H 'Authorization: ApiKey 2a3xrm1eg3t811zv1nt22qj1fr125q2brd13feedaqkzczsq5y2wz' -H 'Content-Type: application/json' 'https://compute.googleapis.com/compute/v1/projects/$PROJECT/zones/$ZONE/instances/$SOURCE_VM' | jq ."
